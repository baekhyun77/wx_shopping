    ...
    <div>
      <el-form ref="loginForm" :model="form" :rules="rules" label-width="80px" class="login-box">
        ...
        <el-form-item label="账号" prop="username">
          <el-input type="text" placeholder="真实姓名" v-model="form.username"/>
        </el-form-item>
        ...
        <el-form-item label="家庭资产" prop="asset">
          <el-input type="text" placeholder="请输入家庭资产" v-model="form.asset"/>
        </el-form-item>
        <el-form-item label="个人资产" prop="u_assets">
          <el-input type="text" placeholder="请输入个人资产" v-model="form.u_assets"/>
        </el-form-item>
        <el-form-item label="电话" prop="u_phone">
          <el-input type="text" placeholder="请输入电话" v-model="form.u_phone"/>
        </el-form-item>
        <el-form-item label="家庭住址" prop="address">
          <el-input type="text" placeholder="请输入家庭住址" v-model="form.address"/>
        </el-form-item>
        <el-form-item>
